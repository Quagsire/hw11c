...
public class LinkedList {
	...
	class Pointer {
		...
		/**
		 * Constructs a pointer that points to the front of the linked list.
		 */
		public Pointer() {
			position = first;
		}
		 ...
		 *             when the pointer is at the past-the-end position.
		 */
		 ...
		 * 
		 * @throws NoSuchElementException
		 *             when trying to move before the first element
		 */
		...
		/**
		 * Removes the element at the pointer and moves the pointer to the next
		 * element.
		 * 
		 * @throws NoSuchElementException
		 *             when the pointer is at the past-the-end position.
